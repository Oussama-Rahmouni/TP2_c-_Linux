...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vehicule.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vehicule.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vehicule ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/Camion_Testeur.o: Camion_Testeur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Camion_Testeur.o Camion_Testeur.cpp
...
${OBJECTDIR}/FonctionsCamion.o: FonctionsCamion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FonctionsCamion.o FonctionsCamion.cpp

${OBJECTDIR}/FonctionsVehicule.o: FonctionsVehicule.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FonctionsVehicule.o FonctionsVehicule.cpp

${OBJECTDIR}/FonctionsVehiculePromenade.o: FonctionsVehiculePromenade.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FonctionsVehiculePromenade.o FonctionsVehiculePromenade.cpp

${OBJECTDIR}/Proprietaire_Testeur.o: Proprietaire_Testeur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Proprietaire_Testeur.o Proprietaire_Testeur.cpp
...
${OBJECTDIR}/VehiculePromenade_Testeur.o: VehiculePromenade_Testeur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VehiculePromenade_Testeur.o VehiculePromenade_Testeur.cpp

${OBJECTDIR}/Vehicule_Testeur.o: Vehicule_Testeur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Vehicule_Testeur.o Vehicule_Testeur.cpp

${OBJECTDIR}/gestionImmatriculation.o: gestionImmatriculation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestionImmatriculation.o gestionImmatriculation.cpp
